...
class AIController(IController):
    ...
    def __init__(self, car: Car, mask_model_dir: str, streaming: bool = False):
        ...
        racing_model_path = "racing/models/model9645239a0f.pth"
        ...
        with TimeLogger("Loading Racing Simulator model", logger):
            self.racing_model = MyModel(input_size=len(self.input_columns), hidden_layers=[32], output_size=2).to(self.device)
